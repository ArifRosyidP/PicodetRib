...
cfg = load_config('configs/picodet/picodet_l_640_coco_lcnet_udtiri.yml')
...
trainer.load_weights('model/picodet_l_640_coco_lcnet_udtiri/best_model_epoch_65.pdparams')
